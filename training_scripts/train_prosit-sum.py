...
but add sum_intensity and method_nbr as an addtional feature to the model.
-> this creates and trains the sum intensity model!
"""

# enter project name
project_name = 'train_with_upd2_v3'
name = 'sum_intensity_model'


TRAIN_DATAPATH = '/cmnfs/proj/prosit/singleCell/train_upd2_modified2.parquet'
TEST_DATAPATH = '/cmnfs/proj/prosit/singleCell/test_upd2_modified2.parquet'
VAL_DATAPATH = '/cmnfs/proj/prosit/singleCell/val_upd2_modified2.parquet'
BATCH_SIZE = 2048
...
save_best = ModelCheckpoint(
    '/cmnfs/proj/prosit/singleCell/best_sum_model.keras',
    monitor="val_loss",
    verbose=1,
    save_best_only=True,
...
#model.load_weights('/cmnfs/proj/prosit/singleCell/best_model_intensity_model.keras')

model.save("/cmnfs/proj/prosit/singleCell/save_sum_model", save_format="tf")
